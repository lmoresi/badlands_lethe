...
##
## Virtual mesh class
## This gives the structure of the meshing classes which needs to be fleshed out later
##

## The Abstract2DMesh needs all the good stuff from the TreMesh class but in skeletal form, I think ... the general methods can live here too ?
